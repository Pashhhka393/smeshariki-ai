const Footer = () => {
  return (
    <footer className="max-w-7xl mx-auto py-8 px-4 text-[#879ba6] text-[13px] text-center border-t border-white/40 mt-12">
      <p className="mb-1.5">
        © 2026{" "}
        <span className="font-semibold text-[#4bc5fa]">Смешарики.AI</span>.
        Разработано с любовью студентом группы{" "}
        <span>ИС-22</span> -
        <a
          href="https://github.com/Pashhhka393"
          target="_blank"
          rel="noopener noreferrer"
          className="text-[#1c252c] font-bold hover:text-[#4bc5fa] transition-colors underline ml-1"
        >
          Павел Шевелюхин
        </a>
      </p>
